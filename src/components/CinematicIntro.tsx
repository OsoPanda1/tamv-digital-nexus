...
const ISABELLA_LINES: { text: string; duration: number }[] = [
  { text: "PROTOCOLO DE INMERSIÓN ACTIVADO...", duration: 3800 },
  { text: "TE ESTABAMOS ESPERANDO", duration: 5500 },
  { text: "ESTO ES INNOVACION LATINA, HAGAMOS HISTORIA.", duration: 7000 },
  { text: "HOY DESEAMOS ANUNCIAR AL MUNDO UN MENSAJE:", duration: 6200 },
  { text: "UNA NUEVA ERA DIGITAL HA DADO COMIENZO, Y LATINOAMÉRICA ES QUIEN LA LIDERA.", duration: 8500 },
  {
    text:
      "2026. LATINOAMÉRICA HA DESPERTADO Y HACE UN LLAMADO A TODOS SUS SOÑADORES Y VISIONARIOS " +
